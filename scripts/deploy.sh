...
ssh "${DEPLOY_USER}@${DEPLOY_HOST}" "mkdir -p ~/nginx/metazaurus.com"
rsync -avz nginx/metazaurus.com/nginx.conf "${DEPLOY_USER}@${DEPLOY_HOST}:~/nginx/metazaurus.com/nginx.conf"
